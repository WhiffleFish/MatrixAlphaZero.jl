...
include("ppo_solver_exploitability.jl")

const BENCHMARK_COLUMNS = ("uniform_random", "heuristic", "ppo_br")
const PPO_RESULTS_DIR = joinpath(EXPERIMENT_DIR, "ppo_solver_exploitability_results")
...
function ppo_player_policy(game, solver::AbstractString, player::Int)
    ...
    get(metadata, "br_player", nothing) == player ||

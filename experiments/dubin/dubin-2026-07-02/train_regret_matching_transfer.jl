...
const EXPERIMENT_NAME = "dubin-2026-07-03"
...
# RegretMatchingSearch (MCTS) style: exact counterfactual regrets, no IS.
backup = :sample
value_target = :search
value_weight = 1.0f0
regret_weight = 0.1f0
...
function (cb::StatRolloutEvalCallback)(info::NamedTuple)
    ...
    search = AZ.MCTSSearch(;
        oracle = info.oracle,
        tree_queries = cb.oos_iterations,
